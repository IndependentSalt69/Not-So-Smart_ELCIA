  ...
  const navItems: NavItem[] = [
    {
      id: 'overview',
      label: 'Overview',
      description: 'Command center KPIs & live drone alerts feed',
      icon: Activity,
    },
    {
      id: 'queue',
      label: 'Incidents Queue',
      description: 'Active triage & operator verification protocol',
      icon: Layers,
    ...
    },
    {
      id: 'map',
      label: 'Incident Map',
      description: 'Spatial coordinate tracker across Phase 1 & 2',
      icon: MapPin,
      badge: criticalCount > 0 ? `${criticalCount} P1` : undefined,
    },
    {
      id: 'ingest',
      label: 'AI Ingest Studio',
      description: 'Neural vision inference for drone photos & videos',
      icon: Sparkles,
      badge: 'AI v8.4',
    },
    {
      id: 'analytics',
      label: 'Analytics',
      description: 'Monsoon correlation & zone vulnerability charts',
      icon: BarChart3,
    },
  ];
